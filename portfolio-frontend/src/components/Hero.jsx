...
const Hero = () => {
  ...
  return (
    <section className="flex lg:items-center lg:gap-x-10 h-screen lg:h-max bg-zinc-900 text-white">
      ...
      <div className='flex flex-col justify-center lg:flex-row items-center lg:justify-between w-full max-w-[900px] gap-6'>
        ...
        <img src={CodingSvg} alt="CodingSvg" className="w-64 h-96 lg:w-96" />
      </div>
    </section>
  );
};
